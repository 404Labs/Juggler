...
function scene:show( event )
    ...
    if phase == "will" then
		...
		logo_title=display.newImageRect("back_ground.png",display.contentWidth,display.contentHeight)
		logo_title.x=display.contentWidth/2
		logo_title.y=display.contentHeight/2
