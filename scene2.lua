...
function scene:show( event )
    ...
    if phase == "will" then
			...
			menupage_background=display.newImageRect("testpage.png",display.contentWidth,display.contentHeight)
			menupage_background.x=display.contentWidth/2
			menupage_background.y=display.contentHeight/2
...
function scene:hide( event )
    ...
    elseif phase == "did" then
	display.remove(menupage_background)
	menupage_background=nil
	--removeEventListener
